...
//    private lazy var cancellBarButtonItem: UIBarButtonItem = {
//       return UIBarButtonItem(barButtonSystemItem: .ca, target: self, action: #selector(actionBarButtonTapped))
//    }()
...
//        setupImagesCountLabel()
    ...
    private func setupImagesCountLabel() {
        collectionView.addSubview(imagesCountLabel)
        imagesCountLabel.topAnchor.constraint(equalTo: collectionView.topAnchor, constant: 5).isActive = true
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        imagesCountLabel.isHidden = photos.count == 0
        return photos.count
    }
